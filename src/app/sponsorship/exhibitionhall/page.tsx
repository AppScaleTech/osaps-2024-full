      ...
      <div className="max-w-7xl mx-auto mt-20 px-5 lg:px-10">
        <div className="border-2 border-[#71737A] lg:pl-20 pt-14 pb-5 rounded-t-md ">
          <div className="flex flex-col lg:flex-row justify-center items-center">
            <div className="space-y-5 lg:pr-20">
              <h1 className="text-[32px] font-bold">Exhibition Hall</h1>
              <p>US $ 2,000</p>
        ...
        <div className=" border-x-2 border-b-2 border-[#71737A] rounded-b-md pb-5 mb-20">
          ...
          <ul className="space-y-10 px-10 leading-loose ">
            <li>
              One booth space allocation along the hallway leading to Main
              Convention Hall for the duration of the 3-day conference (July 4
              to 6, 2024)
              <br /> Note: Choice of booth space will be on a “first come, first
              served basis”.
            </li>
            <li>
              &#x2022; Inclusion of company logo on the Convention photo walls
              located in different areas of the convention venue
            </li>

            <li>
              &#x2022; Free admission for one (1) conference participants to the
              Gala Dinner
            </li>
          </ul>
        </div>
