      ...
      <div className="max-w-7xl mx-auto mt-20 px-5 lg:px-10">
        <div className="border-2 border-[#71737A] lg:pl-20 pt-14 pb-5 rounded-t-md ">
          <div className="flex flex-col lg:flex-row justify-center items-center">
            <div className="space-y-5 lg:pr-20">
              <h1 className="text-[32px] font-bold">Platinum</h1>
              <p>US $ 11,000</p>
            ...
            <div className="lg:border-l-2 border-black flex items-center mt-5 lg:mt-0 py-5">
              <p className="lg:pl-5 text-center lg:text-left lg:text-[20px]">
                ...
                dedicated Hospitality Suite, and feature a speaker <br /> for product
                endorsement. Enjoy free admissions, live acknowledgment, and <br />
        ...
        <div className=" border-x-2 border-b-2 border-[#71737A] rounded-b-md pb-5 mb-20">
          ...
          <ul className="space-y-10 px-10 leading-loose ">
            <li>
              &#x2022; Table space or booth inside Main Convention Hall on the
              first day of the conference (July 4, 2024)
            </li>
            <li>
            ...
            <li>
              &#x2022; Use of assigned Conference Room as Hospitality Suite for
              2 days (July 5 and 6, 2024) for better interaction with the
              conference participants
            </li>
            <li>
              &#x2022; Inclusion of one speaker (foreign or local) in the roster
              of invited faculty with an opportunity to give a lecture for the
              purpose of endorsing a product during lunch break on the first day
              (July 4, 2024) of the conference
              <br />
              <span className="font-semibold">Note:</span> The sponsoring
              company should cover all travel-related expenses of their invited
              speaker. A maximum of 30 minutes shall be allocated for the
              lecture and product presentation.
            </li>
            <li>
              &#x2022; Free admission for four conference participants (local or
              foreign) in all scientific sessions, social programs and banquet
              meals for the duration of the 3-day conference
            </li>
            <li>
              &#x2022; Free admission for four (4) conference participants to
              the Gala Dinner
            </li>
            <li>
              &#x2022; Live acknowledgment as Platinum Sponsor during morning
              and afternoon coffee breaks and lunch break for the duration of
      ...
      <div className="bg-[#F2F1E9] flex flex-col lg:flex-row justify-center lg:space-x-10 items-center pb-20">
        ...
        <form className=" w-fit lg:w-[710px] p-5 ml-5 mr-5 bg-white mt-20 rounded-lg">
          ...
          <div className="flex justify-end space-x-5">
            ...
            <button className="bg-[#E2E2E3] px-4 py-3 rounded-full">Submit</button>
          </div>
        </form>
      </div>
    </div>
